...
public class AllPeopleMessage {
	...
	private ArrayList<OnePeoplePai> list;
	// 备用数据1
	...
	public ArrayList<OnePeoplePai> getList() {
		return list;
	}

	public void setList(ArrayList<OnePeoplePai> list) {
		this.list = list;
	}
	...
	public AllPeopleMessage(String act, String zuoNum, ArrayList<OnePeoplePai> list, String resever1, String resever2) {
		super();
		this.act = act;
		this.zuoNum = zuoNum;
		this.list = list;
	...
	public String toString() {
		return "allpeoplemessage [act=" + act + ", zuoNum=" + zuoNum + ", list=" + list + ", resever1=" + resever1
				+ ", resever2=" + resever2 + "]";
	}
